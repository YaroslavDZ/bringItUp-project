...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      this.slides[Math.abs(this.slideIndex - 2) % this.slides.length].classList.remove('animated', 'fadeIn');
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        if (_this2.slides[1].tagName === 'BUTTON' && _this2.slides[2].tagName === 'BUTTON') {
          ...
          _this2.container.appendChild(_this2.slides[0]); // Btn
          ...
          _this2.decorateSlides();
        } else if (_this2.slides[0].tagName === 'BUTTON') {
          _this2.container.appendChild(_this2.slides[0]); // Slide
    ...
    key: "activateSlideAutoplay",
    value: function activateSlideAutoplay() {
      var _this3 = this;
      ...
      this.next.addEventListener('mouseenter', function () {
        clearInterval(_this3.nextSlideInterval);
      });
      this.next.addEventListener('mouseleave', function () {
        _this3.nextSlideInterval = setInterval(function () {
          return _this3.nextSlide();
        }, 5000);
      });
